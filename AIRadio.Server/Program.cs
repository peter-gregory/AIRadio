...
builder.Services.AddHttpClient<ILlamaHttpClient, LlamaHttpClient>(client => client.Timeout = TimeSpan.FromSeconds(300));
...
builder.Services.AddSingleton<ITool, RadioNextTool>();
builder.Services.AddSingleton<ITool, RadioPreviousTool>();
builder.Services.AddSingleton<ITool, RadioVolumeTool>();
...
builder.Services.AddSingleton<ITool, LocationSetTool>();

builder.Services.AddSingleton<ITool, WeatherTool>();
builder.Services.AddSingleton<ITool, ForecastTool>();
builder.Services.AddSingleton<ITool, NewsTool>();
builder.Services.AddSingleton<ITool, TimeTool>();
builder.Services.AddSingleton<ITool, DateTool>();
...
builder.Services.AddSingleton<ITool, EventAddTool>();
