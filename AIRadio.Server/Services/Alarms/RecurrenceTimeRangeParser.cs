...
public static partial class RecurrenceTimeRangeParser
{
    ...
    private static DateTime? ParseTimer(string text, DateTime reference)
    {
        ...
        // Normalize the timer to a minute boundary without losing more than
        // about 30 seconds. Adding 30 seconds before truncating produces an
        // effective delay between the requested duration and duration + 30 seconds.
        var dueAt = reference.Add(delay).AddSeconds(30);
        return new DateTime(
